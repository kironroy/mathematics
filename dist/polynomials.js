...
document.getElementById("moe").innerHTML = "<b> ☑️Moe has spent $".concat(totalGroceryResult, " on groceries.</b>");
// Taxi calculation
var rate = 0.5;
var taxiDlrate = 1.5;
var goal = 100;
...
document.getElementById("taxi").innerHTML = "☑️ Taxi driver has to drive ".concat(taxiResult, " miles to make ").concat(goal, " dollars.");
